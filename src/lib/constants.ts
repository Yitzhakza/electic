export const BRANDS = [
  ...
  { slug: 'changan', nameHe: "צ'אנגאן", nameEn: 'Changan', order: 7, models: ['Deepal S07', 'Deepal L07', 'UNI-V'] },
  { slug: 'chery', nameHe: "צ'רי", nameEn: 'Chery', order: 8, models: ['Tiggo 7 Pro', 'Tiggo 8 Pro', 'eQ7'] },
  { slug: 'zeekr', nameHe: 'זיקר', nameEn: 'Zeekr', order: 9, models: ['001', 'X', '007'] },
  { slug: 'skywell', nameHe: 'סקייוול', nameEn: 'Skywell', order: 10, models: ['ET5'] },
  { slug: 'cupra', nameHe: 'קופרה', nameEn: 'CUPRA', order: 11, models: ['Born'] },
  { slug: 'hyundai', nameHe: 'יונדאי', nameEn: 'Hyundai', order: 12, models: ['Ioniq 5', 'Ioniq 6', 'Kona Electric'] },
  { slug: 'kia', nameHe: 'קיה', nameEn: 'Kia', order: 13, models: ['EV6', 'EV9', 'Niro EV'] },
  { slug: 'volkswagen', nameHe: 'פולקסווגן', nameEn: 'Volkswagen', order: 14, models: ['ID.3', 'ID.4', 'ID.5'] },
  { slug: 'polestar', nameHe: 'פולסטאר', nameEn: 'Polestar', order: 15, models: ['Polestar 2', 'Polestar 4'] },
] as const;
...
export const BRAND_KEYWORDS: Record<string, string[]> = {
  ...
  changan: ['changan', 'deepal', 's07', 'l07', 'uni-v'],
